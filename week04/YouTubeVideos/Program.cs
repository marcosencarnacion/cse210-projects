...
public class Program
{
    static void Main(string[] args)
    {
        ...
        video2.AddComment(new Comment("Sumani", "7 minutes and a lot of things in detail. Thanks Mosh."));
        ...
        video4.AddComment(new Comment("Tracer", "I lost my interest in coding 3 years ago & because of you I am getting into this again."));
        videos.Add(video4);
